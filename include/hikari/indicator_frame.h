/* Script function and purpose: Indicator frame overlay using wlr_scene_rect
nodes for modal view highlighting. */
...
/* Scene-graph backed coloured rectangle frame drawn around a view during modal
operations (group assign, sheet assign, and similar). */
